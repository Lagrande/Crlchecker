...
- **Новое**: Детальный мониторинг изменений реестра АУЦ с уведомлениями о всех типах изменений
- **Новое**: Еженедельная статистика отзыва сертификатов по УЦ и причинам (Опционально)
- **Новое**: Серийные номера CRL, Отпечатки CRL и идентификаторы ключей издателей в уведомлениях
- **Новое**: Фильтрация напрвления уведомлений для CRL АУЦ по ОГРН и реестровым номерам
- **Новое**: Расширенное уведомление «Добавлены новые CRL» с расширенной информацией: Серийный номер CRL, Идентификатор ключа издателя, Средство УЦ, Класс средства УЦ, Кому выдан, Кем выдан, Серийный номер сертификата, Действует, Отпечаток
- **Новое**: Отдельное уведомление о проблеме с загрузкой CRL (URL, УЦ/реестровый номер, CRL Serial Number, Issuer Key Identifier); управление через флаг `NOTIFY_CRL_DOWNLOAD_FAIL=true`

### Переменные окружения
- `TELEGRAM_BOT_TOKEN`: токен Telegram-бота
- `TELEGRAM_CHAT_ID`: ID чата для уведомлений
- `FNS_ONLY`: `true` — только УЦ ФНС; `false` — все УЦ
...
Уведомления CRL:
- `NOTIFY_EXPIRING_CRL`, `NOTIFY_EXPIRED_CRL`, `NOTIFY_NEW_CRL`, `NOTIFY_MISSED_CRL`, `NOTIFY_WEEKLY_STATS`, `NOTIFY_CRL_DOWNLOAD_FAIL`
...
#### Уведомления о пропущенных CRL
```
❌ ОШИБКА: CRL не опубликован вовремя
📁 Имя файла: example.crl
🏢 Удостоверяющий центр: Название УЦ
🔢 Реестровый номер: 123
🔗 URL: http://example.com/crl
📅 Ожидалось: 27.09.2025 10:00:00
🕐 Текущее время: 27.09.2025 12:34:56
```


#### Уведомления: не удалось скачать CRL
```
❗ Не удалось скачать CRL — CRL не существует
🏢 АУЦ: Название УЦ
🔢 Реестровый номер: 123
📁 Имя файла: example.crl
🔗 URL:
• http://example.com/crl
• http://backup.example.com/crl
🔢 Серийный номер CRL: 167e
🔑 Идентификатор ключа издателя: D156FB382C4C55AD7EB3AE0AC66749577F87E116
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: новый действующий АУЦ
```
🆕 Новый действующий АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📅 Дата аккредитации: 01.09.2025 00:00:00
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение даты аккредитации
```
📆 Изменение даты аккредитации АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📅 Старая дата: 01.01.2025 00:00:00
📅 Новая дата: 01.02.2025 00:00:00
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: новые или измененные CRL у действующего АУЦ
```
🔗 Новые или измененные CRL у действующих АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Новые CRL:
...
#### TSL: АУЦ удален из списка
```
🗑️ АУЦ удален из списка
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
🏛️ ОГРН: 1027700132195
📝 Причина: истечение срока аккредитации
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение названия АУЦ
```
📝 Изменение названия АУЦ
📦 Версия TSL: 15671
🔢 Реестровый номер: 123
📄 Было: Старое название АУЦ
📄 Стало: Новое название АУЦ
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение краткого названия АУЦ
```
📝 Изменение краткого названия АУЦ
📦 Версия TSL: 15671
🏢 АУЦ: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Было: Старое краткое
...
📄 Стало: new@example.com
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение веб-сайта
```
🌐 Изменение веб-сайта АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Было: https://old.example.com
📄 Стало: https://new.example.com
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение URL реестра сертификатов
```
📋 Изменение URL реестра сертификатов АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Было: https://old-reg.example.com
📄 Стало: https://new-reg.example.com
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменение адреса АУЦ
```
📍 Изменение адреса АУЦ
📦 Версия TSL: 15671
🏢 Название: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Было: 101000, г. Москва, ул. Старая, д. 1
📄 Стало: 101000, г. Москва, ул. Новая, д. 2
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: добавлены новые CRL (расширенное)
```
➕ Добавлены новые CRL
📦 Версия TSL: 15671
🏢 АУЦ: Примерный АУЦ
...
🔢 Серийный номер CRL: 167e
🔑 Идентификатор ключа издателя: D156FB382C4C55AD7EB3AE0AC66749577F87E116
🛠️ Средство УЦ: КриптоПро УЦ
🏷️ Класс средства УЦ: Класс 1
👤 Кому выдан: CN=Example, O=Org
🏛️ Кем выдан: CN=Root, O=Org
#️⃣ Серийный номер: 01AB
📅 Действует: 01.01.2025–01.01.2026
🔏 Отпечаток: ABCDEF0123456789...
📋 Новые CRL:
• http://example.com/crl1.crl
• http://example.com/crl2.crl
🕐 Время проверки: 27.09.2025 12:34:56
...
🔢 Реестровый номер: 123
📋 Удаленные CRL:
• http://example.com/old1.crl
• http://example.com/old2.crl
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: изменены адреса CRL
```
🔄 Изменены адреса CRL
📦 Версия TSL: 15671
🏢 АУЦ: Примерный АУЦ
🔢 Реестровый номер: 123
📄 Было:
• http://old.example.com/a.crl
• http://old.example.com/b.crl
📄 Стало:
• http://new.example.com/a.crl
• http://new.example.com/b.crl
🕐 Время проверки: 27.09.2025 12:34:56
```

#### TSL: прочие изменения
```
📋 Другие изменения в файле TSL
📦 Версия TSL: 15671
🏢 АУЦ: Примерный АУЦ
🔢 Реестровый номер: 123
📝 Поле: /УдостоверяющийЦентр/ПрочееПоле
...
### Решение проблем возникающих при использовании
...
Система использует SQLite базу данных для хранения списков отозванных сертификатов. Вот полезные запросы для анализа данных:
